<?php
 ...
 function add_book($ISBN){
    ...
    //$parsed_arr = (array)$parsed_xml;
    //print_r($parsed_arr['Items']->Item->DetailPageURL);
    $result = array();
    $result = xml2arr(simplexml_load_string($response));
...
//----- End Added
       ...
       $book->setTitle($result['Items']['Item']['ItemAttributes']['Title']);
       $book->setImage_url($result['Items']['Item']['MediumImage']['URL']);
     
       $book->setPage_Url($result['Items']['Item']['DetailPageURL']);
/*
    $author_name = array();
    $ncr = 0;
