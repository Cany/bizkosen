<?php
   ...
   //  $ISBN     = '4798024031';
	// $ISBN ='4088706145';
     ...
     . '&BrowseNodeId=547670&ResponseGroup=Large&Version=2008-08-19';
...
//get ganle
	$Janle=$Item->BrowseNodes->BrowseNode->Ancestors->BrowseNodeId;
// Get ASIN
    $ASIN       = $Item->ASIN;
// Get Book_Data
...
//
    ...
    //  $book   = $return[0];
	 ...
	 // else if(!($book->getJanle()=="466298")){
      //     echo"ƒGƒ‰[F‚»‚Ì–{‚Í‹Zp‘‚Å‚Í‚ ‚è‚Ü‚¹‚ñ";
		// echo $book->getJanle();
		  // return;
		//   }
      $blank = " ";
      ...
      for ($i=0; $i<sizeof($author_array); $i++) {
       if ( !$author_array[$i]->getRole() ) $role = "’˜";
     ...
     echo $blank . $book->getPrice() . "‰~<br>";
     echo  $blank . $book->getUrl();
      echo "</td>";
      echo "</tr></table>";
      $book = NULL;
      $author_array=NULL;
